...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RedeemHomePageRoutingModule", function() { return RedeemHomePageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _redeem_home_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./redeem-home.page */ "./src/app/RedeemModule/redeem-home/redeem-home.page.ts");
...
let RedeemHomePageRoutingModule = class RedeemHomePageRoutingModule {
};
RedeemHomePageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RedeemHomePageModule", function() { return RedeemHomePageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _redeem_home_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./redeem-home-routing.module */ "./src/app/RedeemModule/redeem-home/redeem-home-routing.module.ts");
/* harmony import */ var _redeem_home_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./redeem-home.page */ "./src/app/RedeemModule/redeem-home/redeem-home.page.ts");
...
let RedeemHomePageModule = class RedeemHomePageModule {
};
RedeemHomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _redeem_home_routing_module__WEBPACK_IMPORTED_MODULE_5__["RedeemHomePageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RedeemHomePage", function() { return RedeemHomePage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let RedeemHomePage = class RedeemHomePage {
    ...
    redeemHomeDetail() {
        this.zone.run(() => {
            ...
            this.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_6__["URLS"].redeemFirstPage, apiKey).subscribe((result) => {
                console.log("redeem home page Api Result==", result);
                if (result.status == 1 || result.status == "1") {
                    this.redeemdata = result;
                    this.allData = result.data;
                    this.settingData = result.data.settings;
                }
                else {
    ...
    information() {
        this.zone.run(() => {
            let termData = {
                "page_title": this.allData.settings.tnc_header,
                "discription": this.allData.tnc
            };
            this.sendData.myParam = termData;
            this.router.navigate(["/redeem-information"]);
        });
    }
    redeemNow() {
        this.zone.run(() => {
            this.router.navigate(["/redeem-voucher-category-list"]);
        });
    }
    statementOrder(clickRedeemData, redirectionValue) {
        this.zone.run(() => {
            this.sendData.myParam = clickRedeemData;
            console.log("click value==", redirectionValue);
            if (redirectionValue == "statement") {
                this.router.navigate(["/accountstatement"]);
            }
            else {
                this.router.navigate(["/redeem-my-order-list"]);
            }
        });
    }
};
RedeemHomePage.ctorParameters = () => [
...
RedeemHomePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-redeem-home',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./redeem-home.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/RedeemModule/redeem-home/redeem-home.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./redeem-home.page.scss */ "./src/app/RedeemModule/redeem-home/redeem-home.page.scss")).default]
    })
], RedeemHomePage);
...
//# sourceMappingURL=RedeemModule-redeem-home-redeem-home-module-es2015.js.map