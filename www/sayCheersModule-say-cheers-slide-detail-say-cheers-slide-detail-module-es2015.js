...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SayCheersSlideDetailPageRoutingModule", function() { return SayCheersSlideDetailPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _say_cheers_slide_detail_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./say-cheers-slide-detail.page */ "./src/app/sayCheersModule/say-cheers-slide-detail/say-cheers-slide-detail.page.ts");
...
let SayCheersSlideDetailPageRoutingModule = class SayCheersSlideDetailPageRoutingModule {
};
SayCheersSlideDetailPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SayCheersSlideDetailPageModule", function() { return SayCheersSlideDetailPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _say_cheers_slide_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./say-cheers-slide-detail-routing.module */ "./src/app/sayCheersModule/say-cheers-slide-detail/say-cheers-slide-detail-routing.module.ts");
/* harmony import */ var _say_cheers_slide_detail_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./say-cheers-slide-detail.page */ "./src/app/sayCheersModule/say-cheers-slide-detail/say-cheers-slide-detail.page.ts");
...
let SayCheersSlideDetailPageModule = class SayCheersSlideDetailPageModule {
};
SayCheersSlideDetailPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _say_cheers_slide_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__["SayCheersSlideDetailPageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SayCheersSlideDetailPage", function() { return SayCheersSlideDetailPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let SayCheersSlideDetailPage = class SayCheersSlideDetailPage {
    // request_tab:any;
    constructor(router, apiservices, zone, sendData) {
        this.router = router;
        ...
        this.cheerBoardData = this.sendData.sayCheers;
        // this.request_tab=this.sendData.myParam;
        console.log('clicked', this.cheerBoardData);
        this.showData = true;
        this.cheersSlide = {
            speed: "500", initialSlide: this.cheerBoardData.index, slidesPerView: 1, spaceBetween: 10, pager: true,
        };
    }
    ngOnInit() { }
    goToMessage(cheerData, scrollValue) {
        this.zone.run(() => {
    ...
    seeNextSlide(ind) {
        this.zone.run(() => {
            ...
            this.slideWithNav.isEnd().then((val) => {
                if (val == true) {
                    // this.router.navigate(['/enternumber']);
                }
                else {
                    this.slideWithNav.slideNext(500, true);
                }
            });
        });
    }
    seePreSlide() {
        this.zone.run(() => {
            this.slideWithNav.getActiveIndex().then((num) => {
                console.log('preview Slider==', num);
                if (num >= 1) {
                    this.slideWithNav.lockSwipes(false).then(() => {
                        this.slideWithNav.slideTo(num - 1, 500, true).then(() => {
    ...
    slideChangeDetect() {
        this.zone.run(() => {
            ...
            if (this.cheerBoardData.allData.length >= 10) {
                if (this.activeSliderIndexDetect == ((_a = this.cheerBoardData) === null || _a === void 0 ? void 0 : _a.allData.length) - 5) {
                    this.value = (_b = this.cheerBoardData) === null || _b === void 0 ? void 0 : _b.allData.length;
                    this.leaderCheerData();
                }
            }
        });
    }
    ionSlideDidChange() {
        this.zone.run(() => {
            ...
            setTimeout(() => {
                ...
                console.log("thought auto id 1==", this.activeSliderIndexDetect);
            }, 500);
            // this.CommentDetailsList();
            this.slideWithNav.isEnd().then(res => {
                if (res == true) {
                    this.value = this.cheerBoardData.allData.length;
                    this.leaderCheerData();
                }
            });
        });
    ...
    leaderCheerData() {
        this.zone.run(() => {
            ...
            this.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_5__["URLS"].leaderCheerApiUrl, apikey).subscribe((result) => {
                console.log("noticeBoard List api result==", result);
                if (result.status == 1 || result.status == '1') {
                    this.cheerBoardData.allData = this.cheerBoardData.allData.concat(result.data.boardlist.board_list);
                    console.log("this.cheerBoardData.allData==", this.cheerBoardData.allData);
                }
                else {
...
SayCheersSlideDetailPage.ctorParameters = () => [
...
SayCheersSlideDetailPage.propDecorators = {
    ...
    slides: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonSlides"],] }]
};
SayCheersSlideDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-say-cheers-slide-detail',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./say-cheers-slide-detail.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sayCheersModule/say-cheers-slide-detail/say-cheers-slide-detail.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./say-cheers-slide-detail.page.scss */ "./src/app/sayCheersModule/say-cheers-slide-detail/say-cheers-slide-detail.page.scss")).default]
    })
...
//# sourceMappingURL=sayCheersModule-say-cheers-slide-detail-say-cheers-slide-detail-module-es2015.js.map