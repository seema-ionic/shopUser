...
/* harmony import */ var _idea_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./idea.page */ "./src/app/IdeaBoxModule/idea/idea.page.ts");
...
IdeaPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _idea_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./idea-routing.module */ "./src/app/IdeaBoxModule/idea/idea-routing.module.ts");
/* harmony import */ var _idea_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./idea.page */ "./src/app/IdeaBoxModule/idea/idea.page.ts");
...
IdeaPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _idea_routing_module__WEBPACK_IMPORTED_MODULE_5__["IdeaPageRoutingModule"], src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"]
        ],
...
let IdeaPage = class IdeaPage {
    constructor(router, sendData, camera, zone, localStorage, apiservices, navctrl) {
        this.router = router;
    ...
    attachment(event) {
        ...
        if (event.target.files) {
            ...
            reader.onload = () => {
                ...
                let extenstion = file.type.split("/");
                console.log('this.currentObj==>', this.attachData);
                if (extenstion[1] == 'pdf') {
                    this.mediaType = "4";
                    this.pdfData = file.name;
                    console.log('this.currentObj==>', this.pdfData);
                    //  this.pdfData= window.URL.createObjectURL(this.attachData);
                }
                else {
                    this.mediaType = "1";
                    console.log('this.currentObj==>', this.mediaType);
                }
        ...
        this.zone.run(() => {
            ...
            this.localStorage.getStorage().then(stored => {
                let apiKey = {
                    ...
                    "category_id": this.autoId,
                    "citation": this.suggestions,
                    "media_type": this.mediaType,
                    "media": this.attachData
                };
                let copy_apiKey = {
                    "employee_id": stored.employeeID,
                    "category_id": this.autoId,
                ...
                this.apiservices.apiCallWithLoginTokenComment(src_assets_constant__WEBPACK_IMPORTED_MODULE_7__["URLS"].ideaBoxListApi, apiKey, copy_apiKey).subscribe((result) => {
                    ...
                    if (result.status == 1 || result.status == '1') {
                        ...
                        this.mediaType = '';
                        this.categoryVal = '';
                        // this.sendData.alldata={"apiRes":result ,"formData":apiKey};
    ...
    opencam() {
        ...
        this.camera.getPicture(options).then((imageData) => {
            ...
            this.attachData = 'data:image/jpeg;base64,' + imageData;
            this.showFilterDiv = false;
            this.mediaType = "1";
        }, (err) => {
            // Handle error
    ...
    categoryList() {
        this.zone.run(() => {
            this.localStorage.getStorage().then(stored => {
                ...
                console.log("resend OTP by Voice Call, api key", apiKey);
                this.apiservices.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_7__["URLS"].ideaCategoryListApi, apiKey).subscribe((result) => {
                    console.log("resend OTP by Voice Call, api response==", result);
                    if (result.status == 1 || result.status == '1') {
...
IdeaPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-idea',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./idea.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/IdeaBoxModule/idea/idea.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./idea.page.scss */ "./src/app/IdeaBoxModule/idea/idea.page.scss")).default]
    })
], IdeaPage);
...
//# sourceMappingURL=IdeaBoxModule-idea-idea-module-es2015.js.map