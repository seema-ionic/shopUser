...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SayCheersBoardPageRoutingModule", function() { return SayCheersBoardPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _say_cheers_board_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./say-cheers-board.page */ "./src/app/sayCheersModule/say-cheers-board/say-cheers-board.page.ts");
...
let SayCheersBoardPageRoutingModule = class SayCheersBoardPageRoutingModule {
};
SayCheersBoardPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SayCheersBoardPageModule", function() { return SayCheersBoardPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _say_cheers_board_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./say-cheers-board-routing.module */ "./src/app/sayCheersModule/say-cheers-board/say-cheers-board-routing.module.ts");
/* harmony import */ var _say_cheers_board_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./say-cheers-board.page */ "./src/app/sayCheersModule/say-cheers-board/say-cheers-board.page.ts");
...
let SayCheersBoardPageModule = class SayCheersBoardPageModule {
};
SayCheersBoardPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _say_cheers_board_routing_module__WEBPACK_IMPORTED_MODULE_5__["SayCheersBoardPageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SayCheersBoardPage", function() { return SayCheersBoardPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let SayCheersBoardPage = class SayCheersBoardPage {
    ...
    ionViewDidEnter() {
        ...
        this.storageService.getStorage().then(res => {
            setTimeout(() => {
                ...
                this.sayCheersBoard = undefined;
                this.cheerBoard = undefined;
                this.value = 0;
                this.sayCheersHome();
                console.log("ionic lifecycle called getStorage==>", res);
            }, 500);
    ...
    //   });
    // }
    goToBadgeList(totalCount, value) {
        this.zone.run(() => {
    ...
    segmentChanged(ev, tabsData) {
        this.zone.run(() => {
            ...
            this.zone.run(() => {
                ...
                if (this.segmentSectionDiv == 'leader') {
                    console.log('Segment changed100', ev.detail.value);
                    this.leaderCheerData(tabsData.leaderboard.requestTab);
                }
                else if (this.segmentSectionDiv == 'cheer') {
                    this.cheerBoard = undefined;
                    console.log('Segment changed1000', ev.detail.value);
                    this.leaderCheerData(tabsData.cheerboard.requestTab);
                }
                else {
                    this.cheerBoard = undefined;
                    console.log('Segment changed1000', ev.detail.value);
    ...
    goToNext() {
        this.zone.run(() => {
            this.router.navigate(["/say-cheers-list"]);
        });
    }
    sayCheersHome() {
        this.zone.run(() => {
            ...
            let apikey = {};
            this.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_5__["URLS"].sayCheersHomeApi, apikey).subscribe((result) => {
                ...
                if (result.status == 1 || result.status == '1') {
                    ...
                    this.sayCheersBoard = result.data.settings;
                    this.leaderCheerData(this.sayCheersBoard.cheerboard.requestTab);
                }
                else {
    ...
    goToMessage(index) {
        this.zone.run(() => {
            let obj = {
                allData: this.cheerBoard,
                index: index,
                pageHeader: this.Settings,
            };
            this.sendData.sayCheers = obj;
            // if(this.segmentSectionDiv=='cheer'){
            ...
            // }
            this.router.navigate(["/say-cheers-slide-detail"]);
        });
    }
    leaderCheerData(tabsData) {
        this.zone.run(() => {
            ...
            this.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_5__["URLS"].leaderCheerApiUrl, apikey).subscribe((result) => {
                ...
                if (result.status == 1 || result.status == '1') {
                    this.leaderTitle = result.data.boardlist.list_header;
                    if (this.cheerBoard == undefined) {
                        this.cheerBoard = result.data.boardlist.board_list;
                        console.log("HrPolicy List Infinite Scroll if1==", this.cheerBoard);
                    }
                    else {
                        this.cheerBoard = this.cheerBoard.concat(result.data.boardlist.board_list);
                        console.log("HrPolicy List Infinite Scroll else1==", this.cheerBoard);
                    }
                    if (this.myinfiniteScrollCall == true) {
                        console.log("HrPolicy List Infinite Scroll if2==", this.cheerBoard);
                    ...
                    console.log("HrPolicy List Infinite Scroll12==", this.cheerBoard);
                    if (this.myinfiniteScrollCall == true) {
                        console.log("HrPolicy List Infinite Scroll123==", this.cheerBoard);
                        this.myInfiniteScroll.target.complete();
                        this.myinfiniteScrollCall = false;
                    }
                }
    ...
    doInfinite(infiniteScroll) {
        ...
        setTimeout(() => {
            this.value = this.cheerBoard.length;
            ...
            if (this.segmentSectionDiv == 'cheer') {
                ...
                this.leaderCheerData(this.sayCheersBoard.leaderboard.requestTab);
            }
        }, 500);
    }
};
SayCheersBoardPage.ctorParameters = () => [
...
SayCheersBoardPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-say-cheers-board',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./say-cheers-board.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sayCheersModule/say-cheers-board/say-cheers-board.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./say-cheers-board.page.scss */ "./src/app/sayCheersModule/say-cheers-board/say-cheers-board.page.scss")).default]
    })
], SayCheersBoardPage);
...
//# sourceMappingURL=sayCheersModule-say-cheers-board-say-cheers-board-module-es2015.js.map