(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["hrPolicyModule-hr-policy-detail-hr-policy-detail-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppHrPolicyModuleHrPolicyDetailHrPolicyDetailPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppHrPolicyModuleHrPolicyDetailHrPolicyDetailRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HrPolicyDetailPageRoutingModule", function () {
        return HrPolicyDetailPageRoutingModule;
      });
      /* harmony import */
      ...
      var _hr_policy_detail_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./hr-policy-detail.page */
      ...
      var HrPolicyDetailPageRoutingModule = function HrPolicyDetailPageRoutingModule() {
        _classCallCheck(this, HrPolicyDetailPageRoutingModule);
      };

      HrPolicyDetailPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppHrPolicyModuleHrPolicyDetailHrPolicyDetailModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HrPolicyDetailPageModule", function () {
        return HrPolicyDetailPageModule;
      });
      /* harmony import */
      ...
      var _hr_policy_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./hr-policy-detail-routing.module */
      "./src/app/hrPolicyModule/hr-policy-detail/hr-policy-detail-routing.module.ts");
      /* harmony import */


      var _hr_policy_detail_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./hr-policy-detail.page */
      "./src/app/hrPolicyModule/hr-policy-detail/hr-policy-detail.page.ts");
      /* harmony import */
      ...
      var HrPolicyDetailPageModule = function HrPolicyDetailPageModule() {
        _classCallCheck(this, HrPolicyDetailPageModule);
      };

      HrPolicyDetailPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _hr_policy_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__["HrPolicyDetailPageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_8__["PipesModule"]],
    ...
    /***/
    function srcAppHrPolicyModuleHrPolicyDetailHrPolicyDetailPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppHrPolicyModuleHrPolicyDetailHrPolicyDetailPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HrPolicyDetailPage", function () {
        return HrPolicyDetailPage;
      });
      /* harmony import */
      ...
      var HrPolicyDetailPage = /*#__PURE__*/function () {
        function HrPolicyDetailPage(apiservices, router, zone, menuCtrl, sendData, storageService, eventService) {
          _classCallCheck(this, HrPolicyDetailPage);
        ...
        _createClass(HrPolicyDetailPage, [{
          key: "videoZoome",
          ...
          value: function ionViewWillEnter() {
            ...
            this.eventService.getObservable().subscribe(function (data) {
              if (data.data.commingFrom == 'quizScoreCard' && data.data.reloadPage == true) {
                console.log("will enter api1 ==", _this3.apiservices.hrPolicyCount);
                _this3.HRdetial = "";
                _this3.settings = "";
                _this3.authData = "";
          ...
          value: function hrPolicyFunc() {
            ...
            this.zone.run(function () {
              ...
              var apikey = {
                "hrpolicy_id": _this4.policyData.hrpolicy_id
              };

              _this4.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_4__["URLS"].hrPolicyDetail, apikey).subscribe(function (result) {
                console.log("HrPolicy Detail api result==", result);
                _this4.HRdetial = result.data;
                _this4.settings = result.data.settings;

                if (result.status == 1 || result.status == '1') {
                  _this4.authData = result.data.auth_type;

                  if (result.data.action == "1" || result.data.action == 1) {
                    _this4.redirectionLink = _this4.authData;
                    console.log("hr Policy Detail Array Redirection detail remaining==", _this4.redirectionLink[_this4.apiservices.hrPolicyCount]);
                    console.log("hr Policy Detail Array Redirection authData==", _this4.authData);
                  } else {// this.policyData.action="0";
                  }
                } else {
          ...
          key: "acknowledgeToGo",
          value: function acknowledgeToGo() {
            var _this5 = this;

            this.zone.run(function () {
              _this5.sendData.hrPolicyDetailAllData = _this5.authData;

              if (_this5.authData.length > 0) {
                if (_this5.redirectionLink[_this5.apiservices.hrPolicyCount].type == "Submit") {
                  // no further action required 
                  // therefore go to hrpolicy list pageconsole.log("HrPolicy Detail api call function");
                  var apikey = {
                    "post_id": _this5.policyData.hrpolicy_id
                  };

                  _this5.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_4__["URLS"].hrPolicySubmit, apikey).subscribe(function (result) {
                    console.log("HrPolicy Detail api result==", result);

                    if (result.status == 1 || result.status == '1') {
                      _this5.policyData.action = "0";
                      var data = {
                        "commingFrom": "reloadHomeApi",
                        "reloadHomePage": true
                      };

                      _this5.eventService.publishSomeData({
                        data: data
                      });

                      if (_this5.commingData.commingFrom == "hrPolicyList") {
                        _this5.router.navigate(["/hr-policy-list"]);
                      } else {
                        _this5.router.navigate(["/tabs/tab1"]);
                      }
                    } else {
                      _this5.apiservices.showToastMessage(result.message, 'top', 3000, 'redBg');
                    }
                  }, function (err) {
                    _this5.apiservices.showToastMessage(err, 'top', 3000, 'redBg');
                  });
                } else if (_this5.redirectionLink[_this5.apiservices.hrPolicyCount].type == "OTP") {
                  // in case of otp, we will update "this.apiservices.hrPolicyCount" value after otp submittion
                  // therefore go to otp page
                  console.log("noticeBoard Detail api call function==", _this5.redirectionLink[_this5.apiservices.hrPolicyCount]);

                  _this5.apiservices.showLoader();

                  var _apikey = {
                    "post_id": _this5.policyData.hrpolicy_id,
                    "event": _this5.settings.otp_event
                  };

                  _this5.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_4__["URLS"].sendOtp, _apikey).subscribe(function (result) {
                    console.log("noticeBoard Detail api result==", result);

                    _this5.apiservices.hideLoader();

                    if (result.status == 1 || result.status == '1') {
                      _this5.sendData.alldata = _this5.policyData;
                      _this5.sendData.myParam = result.data.settings;
                      _this5.sendData.commingPageName = _this5.commingData;

                      _this5.router.navigate([_this5.redirectionLink[_this5.apiservices.hrPolicyCount].data.redirect_page]);
                    } else {
                      _this5.apiservices.showToastMessage(result.message, 'top', 3000, 'redBg');
                    }
                  }, function (err) {
                  ...
                  _this5.sendData.alldata = _this5.policyData;
                  _this5.sendData.myParam = _this5.redirectionLink[_this5.apiservices.hrPolicyCount];
                  console.log("apiservices hrpolicy count==", _this5.apiservices.hrPolicyCount);
                  console.log("apiservices hrpolicy redirection==", _this5.redirectionLink[_this5.apiservices.hrPolicyCount]);
                  _this5.sendData.commingPageName = _this5.commingData;
      ...
      HrPolicyDetailPage.ctorParameters = function () {
        return [{
      ...
      HrPolicyDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-hr-policy-detail',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./hr-policy-detail.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/hrPolicyModule/hr-policy-detail/hr-policy-detail.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./hr-policy-detail.page.scss */
        "./src/app/hrPolicyModule/hr-policy-detail/hr-policy-detail.page.scss"))["default"]]
      })], HrPolicyDetailPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=hrPolicyModule-hr-policy-detail-hr-policy-detail-module-es5.js.map