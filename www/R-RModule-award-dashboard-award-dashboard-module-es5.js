(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["R-RModule-award-dashboard-award-dashboard-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppRRModuleAwardDashboardAwardDashboardPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppRRModuleAwardDashboardAwardDashboardRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AwardDashboardPageRoutingModule", function () {
        return AwardDashboardPageRoutingModule;
      });
      /* harmony import */
      ...
      var _award_dashboard_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var AwardDashboardPageRoutingModule = function AwardDashboardPageRoutingModule() {
        _classCallCheck(this, AwardDashboardPageRoutingModule);
      };

      AwardDashboardPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppRRModuleAwardDashboardAwardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AwardDashboardPageModule", function () {
        return AwardDashboardPageModule;
      });
      /* harmony import */
      ...
      var _award_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./award-dashboard-routing.module */
      "./src/app/R&RModule/award-dashboard/award-dashboard-routing.module.ts");
      /* harmony import */


      var _award_dashboard_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./award-dashboard.page */
      "./src/app/R&RModule/award-dashboard/award-dashboard.page.ts");
      /* harmony import */
      ...
      var AwardDashboardPageModule = function AwardDashboardPageModule() {
        _classCallCheck(this, AwardDashboardPageModule);
      };

      AwardDashboardPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _award_dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__["AwardDashboardPageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]],
    ...
    /***/
    function srcAppRRModuleAwardDashboardAwardDashboardPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppRRModuleAwardDashboardAwardDashboardPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AwardDashboardPage", function () {
        return AwardDashboardPage;
      });
      /* harmony import */
      ...
      var AwardDashboardPage = /*#__PURE__*/function () {
        function AwardDashboardPage(zone, apiservices, stoargeServices, sendData, router) {
          _classCallCheck(this, AwardDashboardPage);
        ...
        _createClass(AwardDashboardPage, [{
          key: "ngOnInit",
          ...
          key: "gotoActvityDetail",
          value: function gotoActvityDetail(item) {
            this.sendData.alldata = item;
            this.router.navigate(['/myactivity-detail']);
          }
        }, {
          key: "segmentData",
          value: function segmentData(ev) {
          ...
          key: "selcetedOption",
          value: function selcetedOption(ev) {
            console.log('eve', ev);
          ...
          key: "gotoDashboardDetail",
          value: function gotoDashboardDetail(item) {
            this.sendData.alldata = item;
            this.router.navigate(['/awarddashboard-detail']);
          }
        }, {
          key: "showUpperData",
          value: function showUpperData(ind) {
                      ...
                      case 0:
                        ...
                        this.stoargeServices.getStorage().then(function (storedData) {
                          var apiKey = {
                            ...
                            tab_type: _this2.tabType,
                            filter: _this2.filterData || '',
                            limit: _this2.limit
                          };

                          _this2.apiservices.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_6__["URLS"].awardDashboardApi, apiKey).subscribe(function (result) {
                            _this2.apiservices.hideLoader();

                            _this2.dashData = result;

                            if (result.status == 1) {
                              if (_this2.segmentSectionDiv == 'dashboard') {
                                _this2.DashboardData = result.data;
                              } else {
                                if (_this2.myActivityData == undefined) {
                                  _this2.myActivityData = result.data;
                                  console.log("Begin async operation 2==", _this2.myActivityData);
                                } else {
                                  _this2.myActivityData = _this2.myActivityData.concat(result.data);
                                }
                              }
                              ...
                              if (_this2.limit == "0") {
                                _this2.errorImage = result.no_data_image;
                              } else {
          ...
          value: function loadData(infiniteScroll) {
            ...
            setTimeout(function () {
              _this3.limit = _this3.myActivityData.length;
              console.log("Begin async operation 2==", _this3.limit);
              console.log("Begin async operation 2==", _this3.myActivityData);
              _this3.myInfiniteScroll = infiniteScroll;

              _this3.awardDashboardFun();
            }, 500);
          }
        }]);
      ...
      AwardDashboardPage.ctorParameters = function () {
        return [{
      ...
      AwardDashboardPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-award-dashboard',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./award-dashboard.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/R&RModule/award-dashboard/award-dashboard.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./award-dashboard.page.scss */
        "./src/app/R&RModule/award-dashboard/award-dashboard.page.scss"))["default"]]
      })], AwardDashboardPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=R-RModule-award-dashboard-award-dashboard-module-es5.js.map