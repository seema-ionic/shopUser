(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["loginModule-enter-number-enter-number-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppLoginModuleEnterNumberEnterNumberPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppLoginModuleEnterNumberEnterNumberRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EnterNumberPageRoutingModule", function () {
        return EnterNumberPageRoutingModule;
      });
      /* harmony import */
      ...
      var _enter_number_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./enter-number.page */
      ...
      var EnterNumberPageRoutingModule = function EnterNumberPageRoutingModule() {
        _classCallCheck(this, EnterNumberPageRoutingModule);
      };

      EnterNumberPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppLoginModuleEnterNumberEnterNumberModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EnterNumberPageModule", function () {
        return EnterNumberPageModule;
      });
      /* harmony import */
      ...
      var _enter_number_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./enter-number-routing.module */
      "./src/app/loginModule/enter-number/enter-number-routing.module.ts");
      /* harmony import */


      var _enter_number_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./enter-number.page */
      "./src/app/loginModule/enter-number/enter-number.page.ts");
      /* harmony import */
      ...
      var EnterNumberPageModule = function EnterNumberPageModule() {
        _classCallCheck(this, EnterNumberPageModule);
      };

      EnterNumberPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _enter_number_routing_module__WEBPACK_IMPORTED_MODULE_5__["EnterNumberPageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]],
    ...
    /***/
    function srcAppLoginModuleEnterNumberEnterNumberPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppLoginModuleEnterNumberEnterNumberPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EnterNumberPage", function () {
      ...
      var EnterNumberPage = /*#__PURE__*/function () {
        function EnterNumberPage(apiservices, router, zone, sendData) {
          _classCallCheck(this, EnterNumberPage);
        ...
        _createClass(EnterNumberPage, [{
          ...
          value: function goToNext() {
            ...
            this.zone.run(function () {
              console.log("checkSumKey==", _this.apiservices.checkSumKey);

              _this.apiservices.showLoader();

              console.log("organisation api fun called");
              var apiKey = {
                "country_code": _this.countryCode.trim(),
                "phone": _this.enterMobile.trim(),
                "event": 'login'
              };
              console.log("organisation api key", apiKey);

              _this.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_4__["URLS"].loginOtpSend, apiKey).subscribe(function (result) {
                ...
                if (result.status == 1 || result.status == '1') {
                  ...
                  _this.sendData.alldata = result.data.settings;

                  _this.router.navigate(["/enter-otp"]);
                } else {
          ...
          value: function changeCountryCode(codeCountry, value) {
            var _this2 = this;
            ...
            this.zone.run(function () {
              ...
              if (value == "country") {
                _this2.countryCode = codeCountry.trim();

                if (_this2.countryCode != '') {
                  console.log("check condition==", _this2.btnDisable);
                  console.log("validate mobile on login page==", _this2.countryCode); // var regexEmail = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?0]+/; //first no.should not be 0

                  var regexEmail = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/; //first no.should not be 0

                  if (!regexEmail.test(codeCountry)) {
                    _this2.countryOk = true;
                    _this2.countryCode = codeCountry;
                    console.log("filled mobile number123==", _this2.countryCode);
                    _this2.countryErr = '';
                  } else {
                    _this2.countryOk = false;
                    _this2.mobileErr = '';
                    _this2.countryErr = "<sup>*</sup>You can't add any special symbol in country code (eg:- +, -. * etc)";
                  }
                } else {
                ...
                _this2.enterMobile = codeCountry.trim();

                if (_this2.enterMobile != '') {
                  console.log("check condition==", _this2.btnDisable);
                  console.log("validate mobile on login page==", _this2.countryCode);
                  var regexEmail = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/; //first no.should not be 0

                  if (!regexEmail.test(codeCountry)) {
                    _this2.MobileIsOk = true;
                    _this2.enterMobile = codeCountry;
                    console.log("filled mobile number123==", _this2.enterMobile);
                    _this2.mobileErr = '';
                  } else {
                    _this2.MobileIsOk = false;
                    _this2.countryErr = '';
                    _this2.mobileErr = "<sup>*</sup>You can't add any special symbol in country code (eg:- +, -. * etc)";
                  }
                } else {
      ...
      EnterNumberPage.ctorParameters = function () {
        return [{
      ...
      EnterNumberPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-enter-number',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./enter-number.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/loginModule/enter-number/enter-number.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./enter-number.page.scss */
        "./src/app/loginModule/enter-number/enter-number.page.scss"))["default"]]
      })], EnterNumberPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=loginModule-enter-number-enter-number-module-es5.js.map