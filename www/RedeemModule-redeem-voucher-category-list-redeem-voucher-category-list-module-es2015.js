...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RedeemVoucherCategoryListPageRoutingModule", function() { return RedeemVoucherCategoryListPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _redeem_voucher_category_list_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./redeem-voucher-category-list.page */ "./src/app/RedeemModule/redeem-voucher-category-list/redeem-voucher-category-list.page.ts");
...
let RedeemVoucherCategoryListPageRoutingModule = class RedeemVoucherCategoryListPageRoutingModule {
};
RedeemVoucherCategoryListPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RedeemVoucherCategoryListPageModule", function() { return RedeemVoucherCategoryListPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _redeem_voucher_category_list_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./redeem-voucher-category-list-routing.module */ "./src/app/RedeemModule/redeem-voucher-category-list/redeem-voucher-category-list-routing.module.ts");
/* harmony import */ var _redeem_voucher_category_list_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./redeem-voucher-category-list.page */ "./src/app/RedeemModule/redeem-voucher-category-list/redeem-voucher-category-list.page.ts");
...
let RedeemVoucherCategoryListPageModule = class RedeemVoucherCategoryListPageModule {
};
RedeemVoucherCategoryListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _redeem_voucher_category_list_routing_module__WEBPACK_IMPORTED_MODULE_5__["RedeemVoucherCategoryListPageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RedeemVoucherCategoryListPage", function() { return RedeemVoucherCategoryListPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let RedeemVoucherCategoryListPage = class RedeemVoucherCategoryListPage {
    // showErrorImage:any="";
    // no_data_message:any="";
    constructor(router, storageService, apiservices, sendData, zone) {
        this.router = router;
    ...
    redeemHomeDetail() {
        this.zone.run(() => {
            ...
            this.apiservices.apiCallWithLoginToken(_src_assets_constant__WEBPACK_IMPORTED_MODULE_6__["URLS"].redeemCategoryList, apiKey).subscribe((result) => {
                console.log("redeem home page Api Result==", result);
                this.categoryData = result.data;
                if (result.status == 1 || result.status == '1') {
                    if (this.categoryListData == undefined) {
                        this.categoryListData = result.data.categories;
                        console.log("noticeBoard List Infinite Scroll if1==", this.categoryListData);
                    }
                    else {
                        this.categoryListData = this.categoryListData.concat(result.data.categories);
                        console.log("noticeBoard List Infinite Scroll else1==", this.categoryListData);
                    }
                    if (this.myinfiniteScrollCall == true) {
                        console.log("noticeBoard List Infinite Scroll if2==", this.categoryListData);
                        this.myInfiniteScroll.target.complete();
                        this.errorMessage = "";
                        this.myinfiniteScrollCall = false;
                    }
                    console.log("thoughtOftheDayApi List data1==", this.categoryListData);
                    ...
                    console.log("noticeBoard List Infinite Scroll12==", this.categoryListData);
                    if (this.myinfiniteScrollCall == true) {
                        console.log("noticeBoard List Infinite Scroll123==", this.categoryListData);
                        this.myInfiniteScroll.target.complete();
                        this.myinfiniteScrollCall = false;
                    }
                }
    ...
    voucherList(categoryClickData) {
        this.zone.run(() => {
            this.sendData.alldata = categoryClickData;
    ...
    doInfinite(infiniteScroll) {
        ...
        setTimeout(() => {
            this.value = this.categoryListData.length;
...
RedeemVoucherCategoryListPage.ctorParameters = () => [
...
RedeemVoucherCategoryListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-redeem-voucher-category-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./redeem-voucher-category-list.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/RedeemModule/redeem-voucher-category-list/redeem-voucher-category-list.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./redeem-voucher-category-list.page.scss */ "./src/app/RedeemModule/redeem-voucher-category-list/redeem-voucher-category-list.page.scss")).default]
    })
...
//# sourceMappingURL=RedeemModule-redeem-voucher-category-list-redeem-voucher-category-list-module-es2015.js.map