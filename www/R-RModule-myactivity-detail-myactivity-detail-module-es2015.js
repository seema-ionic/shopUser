...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyactivityDetailPageRoutingModule", function() { return MyactivityDetailPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _myactivity_detail_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./myactivity-detail.page */ "./src/app/R&RModule/myactivity-detail/myactivity-detail.page.ts");
...
let MyactivityDetailPageRoutingModule = class MyactivityDetailPageRoutingModule {
};
MyactivityDetailPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyactivityDetailPageModule", function() { return MyactivityDetailPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _myactivity_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./myactivity-detail-routing.module */ "./src/app/R&RModule/myactivity-detail/myactivity-detail-routing.module.ts");
/* harmony import */ var _myactivity_detail_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./myactivity-detail.page */ "./src/app/R&RModule/myactivity-detail/myactivity-detail.page.ts");
...
let MyactivityDetailPageModule = class MyactivityDetailPageModule {
};
MyactivityDetailPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _myactivity_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__["MyactivityDetailPageRoutingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyactivityDetailPage", function() { return MyactivityDetailPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
let MyactivityDetailPage = class MyactivityDetailPage {
    constructor(zone, apiservices, stoargeServices, sendData, router, navctrl, alertController) {
        this.zone = zone;
    ...
    ngOnInit() {
        this.previousActvity = this.sendData.alldata;
        // this.myactvityFun();
    }
    ionViewWillEnter() {
        this.myactvityFun();
        ...
        this.zone.run(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.stoargeServices.getStorage().then(storedData => {
                let apiKey = {
                    ...
                    award_id: this.previousActvity.award_id,
                    nomination_id: this.previousActvity.auto_id
                };
                this.apiservices.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_7__["URLS"].myactvityApi, apiKey).subscribe((result) => {
                    this.apiservices.hideLoader();
                    this.myActvity = result;
                    if (result.status == 1) {
                        this.myActvityData = result.data;
                        this.errorMessage = '';
                    }
                    else {
                        this.myActvityData = {};
        ...
        this.zone.run(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.stoargeServices.getStorage().then(storedData => {
                let apiKey = {
                    ...
                    award_id: this.previousActvity.award_id,
                    nomination_id: this.previousActvity.auto_id,
                    approval_level: this.myActvity.approval_level,
                    action: item.value,
                    citation: this.RemarkText
                };
                let copy_apiKey = {
                    employee_id: storedData.employeeID,
                    award_id: this.previousActvity.award_id,
                ...
                this.apiservices.apiCallWithLoginTokenComment(src_assets_constant__WEBPACK_IMPORTED_MODULE_7__["URLS"].nominationActionApi, apiKey, copy_apiKey).subscribe((result) => {
                    this.apiservices.hideLoader();
                    if (result.status == 1) {
                        this.navctrl.pop();
                    }
    ...
    gotoEdit() {
        this.sendData.alldata = { mainData: this.myActvity, nominationId: this.previousActvity.auto_id };
        this.router.navigate(['/award-employee-list']);
    }
};
MyactivityDetailPage.ctorParameters = () => [
...
MyactivityDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-myactivity-detail',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./myactivity-detail.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/R&RModule/myactivity-detail/myactivity-detail.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./myactivity-detail.page.scss */ "./src/app/R&RModule/myactivity-detail/myactivity-detail.page.scss")).default]
    })
...
//# sourceMappingURL=R-RModule-myactivity-detail-myactivity-detail-module-es2015.js.map